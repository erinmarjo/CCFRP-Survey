...
beforR<-ggplot(q9.R, aes(x=q9, y=pct9, fill=Region, label = paste0(pct9, "%")))+
  geom_bar(stat="identity", position=position_dodge(1), color="black")+
  scale_x_discrete(labels = beforeafter)+
  scale_y_continuous(limits = c(0,85))+
  scale_fill_discrete(labels = institution, "Institution")+
...
after<-ggplot(q11.R, aes(x=q11, y=pct11, fill=Region, label = paste0(pct11, "%")))+
  geom_bar(stat="identity", position=position_dodge(1), color="black")+
  scale_x_discrete(labels = beforeafter)+
  scale_y_continuous(limits = c(0,85))+
  labs(x = '', y = 'Percent\n') +
...
ggplot(q911.R, aes(x=q11, y=change, fill=Region, label = paste0(change, "%")))+
  geom_bar(stat="identity", position=position_dodge(1), color="black")+
  scale_x_discrete(labels = beforeafter)+
 # scale_y_continuous(limits = c(0,85))+
  labs(x = '', y = 'Percent\n') +
...
Examine the Magnitude of Change in perception of MPAs after working with CCFRP.
